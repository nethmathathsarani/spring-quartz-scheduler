...
public class SimpleJob extends QuartzJobBean implements Job {
    ...
    @Autowired
    private com.test.demo.repository.NotificationSubscriptionRepository NotificationSubscriptionRepository;
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(SimpleJob.class);
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) {
        ...
        logger.info("[NBREQ] - Simple Job started with key " + key.getName());
